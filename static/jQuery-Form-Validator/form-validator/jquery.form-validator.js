...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    LANG: {
      errorTitle: '数据保存失败!',
      requiredField: '这个字段是比选项！',
      requiredFields: '您没有填写所有的必选项目',
      badTime: '您填写的时间错误！',
      badEmail: '您填写的邮箱地址格式错误！',
      badTelephone: '您填写的手机号码格式错误！',
      badSecurityAnswer: '您个填写的内容不符合要求！',
      badDate: '您给出的日期格式错误！',
      lengthBadStart: '输入值必须 ',
      lengthBadEnd: ' 个字符',
      lengthTooLongStart: '输入的值不能超过 ',
      lengthTooShortStart: '输入的值不能少于 ',
      notConfirmed: '输入的值没有通过审核！',
      badDomain: '错误的域名',
      badUrl: '不是一个正确的网址！',
      badCustomVal: '输入的数据不正确！',
      andSpaces: ' 和 空格 ',
      badInt: '输入的数据不是一个整形的数字！',
      badSecurityNumber: '您的身份证号码不正确！',
      badUKVatAnswer: 'Incorrect UK VAT Number',
      badUKNin: 'Incorrect UK NIN',
      badUKUtr: 'Incorrect UK UTR Number',
      badStrength: '密码不是很安全！',
      badNumberOfSelectedOptionsStart: '您必须至少选择 ',
      badNumberOfSelectedOptionsEnd: ' answers',
      badAlphaNumeric: '输入的值必须含有一个特殊字符！',
      badAlphaNumericExtra: ' 和 ',
      wrongFileSize: '您上传的文件太大 (最大 %s)',
      wrongFileType: '只有以下文件类型 %s 是允许的',
      groupCheckedRangeStart: '请选择 ',
      groupCheckedTooFewStart: '请至少选择 ',
      groupCheckedTooManyStart: '最多选择 ',
      groupCheckedEnd: ' 项目',
